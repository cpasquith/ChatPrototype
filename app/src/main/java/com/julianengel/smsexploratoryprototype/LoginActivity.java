    ...
    private void attemptLogin() throws ParseException {
        ...
        if (cancel) {
            ...
            //if(ParseUser.getCurrentUser() != null){
              //  System.out.print(ParseUser.getCurrentUser());
            //}
            //else{
                showProgress(false);
                Context context = getApplicationContext();
                int duration = Toast.LENGTH_LONG;
                CharSequence incorrectPasswordMessage = "Incorrect Password";

                Toast incorrectPasswordToast;

                incorrectPasswordToast = Toast.makeText(context, incorrectPasswordMessage, duration);
